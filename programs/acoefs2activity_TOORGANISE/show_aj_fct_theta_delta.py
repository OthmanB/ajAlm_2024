...
def grid_aj_mean(numax=None, Dnu=None, Mass=None, Radius=None, Teff=None, epsilon_nl=5*1e-4, a1=1000, dir_core='/Users/obenomar/tmp/test_a2AR/', lmax=3):
	'''
...
def show_aj_fct_theta_delta(numax=2150., Dnu=103.11, a1=1000., epsilon_nl=5*1e-4, dir_core='/Users/obenomar/tmp/test_a2AR/', file_out='aj_theta_delta', lmax=3):
	'''
	...
	'''
	txtsize=15
	theta, delta, aj_grid=grid_aj_mean(numax=numax, Dnu=Dnu, Mass=None, Radius=None, Teff=None, epsilon_nl=epsilon_nl, a1=a1, dir_core=dir_core, lmax=lmax)
	...
	ax_a2.set_xlabel(r'$\theta$ ($^\circ$)', fontsize=txtsize)
	...
	if lmax >= 2:
		...
		ax_a4.set_xlabel(r'$\theta$ ($^\circ$)', fontsize=txtsize)
		...
		if lmax==2: 
			ax_a4.annotate("Averaged over l=1,2", xy=(0.70, 0.05), fontsize=10, ha="left", xycoords=ax_a4.transAxes, color='r')
		if lmax==3: 
			ax_a4.annotate("Averaged over l=1,2,3", xy=(0.70, 0.05), fontsize=10, ha="left", xycoords=ax_a4.transAxes, color='r')
	if lmax >= 3:
		ax_a6.set_ylabel('$a^{(AR)}_6$ (nHz)', fontsize=txtsize)
		ax_a6.set_xlabel(r'$\theta$ ($^\circ$)', fontsize=txtsize)
...
show_aj_fct_theta_delta(numax=2150., Dnu=103.11, a1=0., epsilon_nl=5*1e-4, dir_core='/Users/obenomar/tmp/test_a2AR/', lmax=3) # Makes average for all l up to 3
show_aj_fct_theta_delta(numax=2150., Dnu=103.11, a1=0., epsilon_nl=5*1e-4, dir_core='/Users/obenomar/tmp/test_a2AR/', lmax=2) # Makes average for all l up to 2 (overwrite previous l=1,l=2 averages)
